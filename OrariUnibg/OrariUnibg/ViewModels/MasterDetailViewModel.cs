...
namespace OrariUniBg.ViewModels
{
    public class MasterDetailViewModel : BaseViewModel
    {
        ...
        public MasterDetailViewModel()
        {
            ...
            MenuItems.Add(new OrariUnibg.Models.MenuItem() { Id = 3, Title = "Corsi Suggeriti", MenuType = MenuType.SuggerisciCorsi, Icon = "ic_suggeriti" });

            //**DEBUG
            //MenuItems.Add(new OrariUnibg.Models.MenuItem() { Id = 4, Title = "Impostazioni", MenuType = MenuType.Impostazioni, Icon = "ic_settings" });
